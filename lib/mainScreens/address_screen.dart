...
import 'package:mobileshp_user_app/mainScreens/save_address_screen.dart';
import 'package:mobileshp_user_app/models/address.dart';
import 'package:mobileshp_user_app/widgets/address_design.dart';
...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SimpleAppBar(title: "Mobile Mart",),
